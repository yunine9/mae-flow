...
- Record Grill implementation impact, key function changes, coherent behavior checkpoints, risks, rollback, and domain archive impact in `implementation.md`, not in Story.
