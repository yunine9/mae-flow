...
REFACTOR_SAFETY_SUITES = (
    ...
    ("Interactive Grill state", ("scripts/tests/test_lean_grill_session.py",), 90, 4000),
    ...
    ("Capability CLI prompt contract", ("scripts/tests/test_capability_cli_contract.py",), 90, 5000),
    ...
    ("Interactive Grill receipts", ("scripts/tests/test_lean_grill_receipts.py",), 90, 4000),
