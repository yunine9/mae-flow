...
REFACTOR_SAFETY_SUITES = (
    ...
    ("Lean four-event Hook router",
     ("scripts/tests/test_lean_hook_events.py",), 90, 3000),
    ("Lean Hook protocol adapter",
     ("scripts/tests/test_lean_hook_adapter.py",), 90, 5000),
    ...
    ("Spec2Code 过程件登记纯用例",
     ("scripts/tests/test_spec2code_artifact_use_cases.py",), 180, 5000),
    ("Spec2Code 过程件登记 CLI",
     ("scripts/tests/test_quality_artifact_cli.py",), 180, 5000),
    ("Spec2Code 编码前流程节点",
    ...
    ("Spec2Code Checkpoint 质量子状态",
     ("scripts/tests/test_checkpoint_quality.py",), 180, 5000),
    ("Spec2Code 最小上下文恢复",
     ("scripts/tests/test_spec2code_recovery.py",), 180, 5000),
    ("Spec2Code 质量生产流程串联",
    ...
    ("Workflow 命令提示一致性与活性红线",
     ("scripts/tests/test_command_prompt_agreement.py",
